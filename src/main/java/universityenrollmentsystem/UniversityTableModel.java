...
public class UniversityTableModel extends AbstractTableModel{
    ...
    private String[] columnNames = {"Name", "Surname","Year of Birth", "Date of Birth", "Role"};
    ...
    public int getColumnCount() {
        // when changer the list length this will change automatically
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (columnIndex == 0) { 
         ...
         temp = list.get(rowIndex).getSurname(); 
            ...
            if(list.get(rowIndex).getStringDate()==null) {
                temp = "N/A";
            }else{temp = list.get(rowIndex).getStringDate();}
        }
